...
const texts: Record<string, DemoTexts> = {
  de: {
    ...
    titleAfter: '',
    title: 'Willkommen zur TRAVELOOP Demo',
  ...
  en: {
    ...
    titleAfter: '',
    title: 'Welcome to the TRAVELOOP Demo',
  ...
  es: {
    ...
    titleAfter: '',
    title: 'Bienvenido a la demo de TRAVELOOP',
  ...
  ar: {
    ...
    titleAfter: '',
    title: 'مرحبًا بك في النسخة التجريبية من TRAVELOOP',
  ...
  id: {
    ...
    titleAfter: '',
    title: 'Selamat datang di Demo TRAVELOOP',
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 14 }}>
          ...
          <h2 style={{ margin: 0, fontSize: 17, fontWeight: 700, color: '#111827', display: 'flex', alignItems: 'center', gap: 5 }}>
            {t.titleBefore}<img src="/text-dark.svg" alt="TRAVELOOP" style={{ height: 18 }} />{t.titleAfter}
          </h2>
        </div>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 6, fontSize: 11, color: '#9ca3af' }}>
            ...
            <a href="https://github.com/mauriceboe/TRAVELOOP" target="_blank" rel="noopener noreferrer"
