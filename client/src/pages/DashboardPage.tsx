...
function SpotlightCard({ trip, onEdit, onCopy, onDelete, onArchive, onClick, t, locale }: TripCardProps): React.ReactElement {
  ...
  return (
    <div
      ...
      className="group relative rounded-3xl overflow-hidden cursor-pointer mb-8 traveloop-interactive-card active:scale-[0.995]"
      style={{ minHeight: 360, boxShadow: 'var(--shadow-elevated)', isolation: 'isolate' }}
    >
      {/* Background */}
      ...
      {/* Content */}
      <div className="relative p-6 md:p-8 flex flex-col text-white z-[2]" style={{ minHeight: 360 }}>
        {/* Top: badge + actions */}
        ...
        <div className="flex-1 flex flex-col justify-end mb-4">
          ...
          <h2 className="text-[34px] md:text-[44px] font-extrabold tracking-[-0.03em] leading-[0.95] mb-2">{trip.title}</h2>
          ...
          <div className="mb-4">
            ...
            <div className="h-1.5 bg-white/15 rounded-full overflow-hidden">
              <div
                ...
                style={{
                  width: `${progress}%`,
                  animation: 'traveloop-progress-fill 900ms cubic-bezier(0.23,1,0.32,1) both',
                  ['--traveloop-progress-to' as string]: `${progress}%`,
                }}
              >
...
function MobileTripCard({ trip, onEdit, onCopy, onDelete, onArchive, onClick, t, locale }: Omit<TripCardProps, 'dark'>): React.ReactElement {
  ...
  return (
    <div
      onClick={() => onClick?.(trip)}
      className="group rounded-2xl border overflow-hidden cursor-pointer traveloop-card traveloop-interactive-card"
  ...
  return (
    <div
      ...
      style={{
        ...
        background: hovered ? 'var(--bg-elevated)' : 'var(--bg-card)', borderRadius: 18,
        border: `1px solid ${hovered ? 'color-mix(in srgb, var(--accent) 35%, var(--border-primary))' : 'var(--border-primary)'}`,
        cursor: 'pointer', transition: 'all 0.22s cubic-bezier(0.23,1,0.32,1)',
        boxShadow: hovered ? 'var(--shadow-card)' : '0 1px 3px rgba(0,0,0,0.03)',
...
function SkeletonCard(): React.ReactElement {
  return (
    <div
      className="rounded-2xl border overflow-hidden traveloop-card"
    >
      <div className="traveloop-skeleton" style={{ height: 120, borderRadius: 0 }} />
      <div style={{ padding: '12px 14px 14px', display: 'flex', flexDirection: 'column', gap: 6 }}>
        <div className="traveloop-skeleton" style={{ height: 14, width: '70%' }} />
        <div className="traveloop-skeleton" style={{ height: 11, width: '50%' }} />
      </div>
    </div>
  )
}
...
export default function DashboardPage(): React.ReactElement {
  ...
  return (
    <div className="traveloop-app-shell" style={{ minHeight: '100dvh', display: 'flex', flexDirection: 'column', ...font }}>
      <AnimatedBackground />
      <Navbar />
      {demoMode && <DemoBanner />}
      <div style={{ flex: 1, marginTop: 'var(--nav-h)', position: 'relative', zIndex: 1 }}>
        <div className="traveloop-dashboard-hero" style={{ maxWidth: 1320, margin: '0 auto', paddingTop: 34, paddingLeft: 20, paddingRight: 20, paddingBottom: 'calc(100px + env(safe-area-inset-bottom, 0px))' }}>
          ...
          <div className="md:hidden flex items-center justify-between mb-5">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="w-10 h-10 rounded-xl flex items-center justify-center relative traveloop-card"
          ...
          <div className="md:hidden grid grid-cols-3 gap-2 mb-6">
            ...
            <button
                ...
                className="flex flex-col items-center gap-2 py-3.5 rounded-2xl traveloop-card traveloop-interactive-card traveloop-live-tile"
              >
            ...
            <button
              ...
              className="flex flex-col items-center gap-2 py-3.5 rounded-2xl traveloop-card traveloop-interactive-card traveloop-live-tile"
            >
              <div className="w-9 h-9 rounded-[11px] flex items-center justify-center" style={{ background: '#fee2e2', color: '#b91c1c' }}>
                <Clock size={16} />
              </div>
          ...
          <div className="hidden md:block" style={{ marginBottom: 20 }}>
            ...
            }} className="traveloop-card">
              <div style={{ display: 'flex', alignItems: 'center', gap: 10, flexShrink: 0 }}>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ flexShrink: 0 }}>
                  <rect x="8" y="2" width="8" height="8" fill="currentColor" rx="1" />
                  <rect x="5" y="12" width="14" height="2" fill="currentColor" rx="1" />
                  <rect x="6" y="16" width="12" height="2" fill="currentColor" rx="1" />
                </svg>
              ...
              <div style={{ display: 'inline-flex', gap: 6, alignItems: 'center', marginLeft: 'auto', flexShrink: 0 }}>
                ...
                {can('trip_create') && (
                  <button
                    ...
                    className="traveloop-premium-button traveloop-flight-button"
                  >
          ...
          {showWidgetSettings && (
            <div className="rounded-2xl p-3 mb-4 flex items-center gap-4 traveloop-card traveloop-menu-enter-left">
          ...
          {isLoading && (
            <>
              <div className="traveloop-skeleton" style={{ height: 260, borderRadius: 24, marginBottom: 32 }} />
          ...
          {!isLoading && trips.length === 0 && (
            <div className="traveloop-card traveloop-page-enter traveloop-empty-state" style={{ textAlign: 'center', padding: '72px 24px', borderRadius: 30 }}>
              <div className="traveloop-empty-icon" style={{ width: 88, height: 88, background: 'var(--accent-soft)', borderRadius: 28, display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 22px', color: 'var(--accent)' }}>
                <Map size={38} />
              </div>
              ...
              {can('trip_create') && <button
                onClick={() => { setEditingTrip(null); setShowForm(true) }}
                className="traveloop-premium-button traveloop-flight-button"
                style={{ display: 'inline-flex', alignItems: 'center', gap: 7, padding: '11px 24px', color: '#fff', border: 'none', borderRadius: 14, fontSize: 14, fontWeight: 700, cursor: 'pointer', fontFamily: 'inherit' }}
              >
          ...
          {!isLoading && (viewMode === 'grid' ? rest : trips).length > 0 && (
            viewMode === 'grid' ? (
              <div className="trip-grid hidden md:grid traveloop-stagger" style={{ gap: 16, marginBottom: 40 }}>
                {rest.map(trip => (
                  <TripCard
                    key={trip.id}
                    trip={trip}
              ...
              <div className="hidden md:flex traveloop-stagger" style={{ flexDirection: 'column', gap: 8, marginBottom: 40 }}>
                {trips.map(trip => (
                  <TripListItem
                    key={trip.id}
                    trip={trip}
