const zh: Record<string, string> = {
  ...
  'settings.about.supporters.title': '与 TRAVELOOP 同行的伙伴',
  'settings.about.supporters.subtitle': '当你在规划下一段路线时，这些人也在一起规划 TRAVELOOP 的未来。他们每月的支持直接用于开发与真实投入的时间——让 TRAVELOOP 保持开源。',
  ...
  'login.createAdminHint': '为 TRAVELOOP 设置第一个管理员账户。',
  ...
  'admin.addons.subtitle': '启用或禁用功能以自定义你的 TRAVELOOP 体验。',
  ...
  'admin.github.support': '帮助我继续开发 TRAVELOOP',
  ...
  'admin.update.dockerText': '你的 TRAVELOOP 实例运行在 Docker 中。要更新到 {version}，请在服务器上执行以下命令：',
  ...
  'vacay.sharing': '共享',
  'vacay.sharingHint': '与其他 TRAVELOOP 用户共享你的假期计划',
  'vacay.owner': '所有者',
  ...
  'vacay.inviteHint': '邀请其他 TRAVELOOP 用户共享合并的假期日历。',
  ...
  'journey.pdf.madeWith': '由 TRAVELOOP 制作',
  'journey.pdf.day': '第',
  ...
  'system_notice.v3_photos.body': '行程规划器中的​**照片**标签已被移除。您的照片安全无虑 — TRAVELOOP 从未修改您的 Immich 或 Synology 相册。\n\n照片现在位于 **Journey** 插件中。Journey 是可选的 — 如果尚未启用，请联系管理员在 Admin → 插件 中开启。',
  ...
  'system_notice.v3_mcp.highlight_deprecated': '静态 traveloop_ 令牌已弃用',
  'system_notice.v3_mcp.highlight_tools':      '扩展工具集与提示词',

  // System notices — personal thank you
  'system_notice.v3_thankyou.title': '来自我的一封私人信',
  'system_notice.v3_thankyou.body': '在你继续之前——我想停下来说几句。\n\nTRAVELOOP 最初只是我为自己的旅行而做的一个业余项目。我从未想过它会成长为 4,000 人信赖的冒险规划工具。每一颗星标、每一个 issue、每一个功能请求——我都会读，它们在全职工作和大学学业之间的深夜里支撑着我继续前行。\n\n我想让你们知道：TRAVELOOP 将永远开源，永远可自托管，永远属于你们。没有追踪，没有订阅，没有任何附加条件。只是一个热爱旅行的人为同样热爱旅行的你们打造的工具。\n\n特别感谢 [jubnl](https://github.com/jubnl)——你已经成为一位不可思议的合作者。3.0 版本中许多精彩之处都留下了你的印记。感谢你在这个项目还很粗糙的时候就选择了相信它。\n\n也感谢你们每一位——报告了 bug、翻译了文本、向朋友分享了 TRAVELOOP，或者只是用它规划了一次旅行——**谢谢你们**。你们是这一切存在的原因。\n\n愿我们一起踏上更多的冒险旅程。\n\n— Maurice\n\n---\n\n[加入 Discord 社区](https://discord.gg/7Q6M6jDwzf)\n\n如果 TRAVELOOP 让你的旅行更美好，一杯[小小的咖啡](https://ko-fi.com/mauriceboe)能让这盏灯一直亮着。',
