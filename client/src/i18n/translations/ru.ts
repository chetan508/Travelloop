const ru: Record<string, string> = {
  ...
  'settings.about.supporters.title': 'Спутники TRAVELOOP',
  'settings.about.supporters.subtitle': 'Пока ты планируешь следующий маршрут, эти люди планируют вместе со мной будущее TRAVELOOP. Их ежемесячный взнос идёт напрямую в разработку и реально потраченные часы — чтобы TRAVELOOP оставался Open Source.',
  ...
  'login.createAdminHint': 'Настройте первый аккаунт администратора для TRAVELOOP.',
  ...
  'admin.addons.subtitle': 'Включайте или отключайте функции для настройки TRAVELOOP под себя.',
  ...
  'admin.github.support': 'Помогает продолжать разработку TRAVELOOP',
  'admin.github.error': 'Не удалось загрузить релизы',
  'admin.github.by': 'от',

  'admin.update.available': 'Доступно обновление',
  'admin.update.text': 'Доступна версия TRAVELOOP {version}. У вас установлена {current}.',
  ...
  'admin.update.dockerText': 'Ваш экземпляр TRAVELOOP работает в Docker. Для обновления до {version} выполните следующие команды на сервере:',
  ...
  'vacay.sharingHint': 'Поделитесь планом отпуска с другими пользователями TRAVELOOP',
  'vacay.owner': 'Владелец',
  'vacay.shareEmailPlaceholder': 'Эл. почта пользователя TRAVELOOP',
  ...
  'vacay.inviteHint': 'Пригласите другого пользователя TRAVELOOP для совместного календаря отпусков.',
  ...
  'journey.pdf.madeWith': 'Сделано с помощью TRAVELOOP',
  ...
  // System notices
  'system_notice.welcome_v1.title': 'Добро пожаловать в TRAVELOOP',
  ...
  'system_notice.welcome_v1.hero_alt': 'Живописное место назначения с интерфейсом TRAVELOOP',
  ...
  'system_notice.v3_photos.body': 'Вкладка **Фото** в Планировщике путешествий удалена. Ваши фото в безопасности — TRAVELOOP никогда не изменял вашу библиотеку Immich или Synology.\n\nФото теперь доступны в дополнении **Journey**. Journey необязателен — если он ещё недоступен, попросите администратора включить его в разделе Admin → Дополнения.',
  ...
  'system_notice.v3_mcp.highlight_deprecated': 'Статические токены traveloop_ устарели',
