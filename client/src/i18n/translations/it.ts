const it: Record<string, string | { name: string; category: string }[]> = {
  ...
  'settings.about.supporters.title': 'Compagni di viaggio per TRAVELOOP',
  'settings.about.supporters.subtitle': 'Mentre pianifichi il tuo prossimo itinerario, queste persone aiutano a pianificare il futuro di TRAVELOOP. Il loro contributo mensile va direttamente allo sviluppo e alle ore realmente investite — per mantenere TRAVELOOP Open Source.',
  ...
  'login.createAdminHint': 'Imposta il primo account amministratore per TRAVELOOP.',
  ...
  'admin.addons.subtitle': 'Abilita o disabilita le funzionalità per personalizzare la tua esperienza TRAVELOOP.',
  ...
  'admin.github.by': 'da',
  'admin.github.support': 'Mi aiuta a continuare a sviluppare TRAVELOOP',
  ...
  'admin.update.dockerText': 'La tua istanza TRAVELOOP è in esecuzione in Docker. Per aggiornare alla versione {version}, esegui i seguenti comandi sul tuo server:',
  ...
  'vacay.sharingHint': 'Condividi il tuo piano ferie con altri utenti TRAVELOOP',
  'vacay.owner': 'Proprietario',
  'vacay.shareEmailPlaceholder': 'Email dell\'utente TRAVELOOP',
  ...
  'vacay.inviteHint': 'Invita un altro utente TRAVELOOP a condividere un calendario ferie combinato.',
  ...
  'journey.pdf.madeWith': 'Creato con TRAVELOOP',
  ...
  // System notices
  'system_notice.welcome_v1.title': 'Benvenuto su TRAVELOOP',
  ...
  'system_notice.welcome_v1.hero_alt': 'Destinazione di viaggio panoramica con l\'interfaccia TRAVELOOP',
  ...
  'system_notice.v3_photos.body': '**Foto** nel Pianificatore di Viaggio sono state rimosse. Le tue foto sono al sicuro — TRAVELOOP non ha mai modificato la tua libreria Immich o Synology.\n\nLe foto ora si trovano nel componente aggiuntivo **Journey**. Journey è opzionale — se non è ancora disponibile, chiedi al tuo admin di abilitarlo in Admin → Addon.',
  ...
  'system_notice.v3_mcp.body': "L'integrazione MCP è stata completamente rinnovata. OAuth 2.1 è ora il metodo di autenticazione consigliato. I token statici (traveloop_\u2026) sono deprecati e verranno rimossi in una versione futura.",
  ...
  'system_notice.v3_mcp.highlight_deprecated': 'Token statici traveloop_ deprecati',
