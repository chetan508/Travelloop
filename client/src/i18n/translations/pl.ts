const pl: Record<string, string | { name: string; category: string }[]> = {
  ...
  'settings.about.supporters.title': 'Towarzystwo podróży dla TRAVELOOP',
  'settings.about.supporters.subtitle': 'Gdy planujesz kolejną trasę, te osoby planują razem ze mną przyszłość TRAVELOOP. Ich comiesięczny wkład idzie bezpośrednio na rozwój i realnie przepracowane godziny — aby TRAVELOOP pozostał Open Source.',
  ...
  'login.createAdminHint': 'Skonfiguruj pierwsze konto administratora dla TRAVELOOP.',
  ...
  'admin.addons.subtitle': 'Włączaj lub wyłączaj funkcje, aby dostosować swoje doświadczenie w TRAVELOOP.',
  ...
  'admin.github.support': 'Pomóż mi rozwijać TRAVELOOP',

  'admin.update.available': 'Dostępna aktualizacja',
  'admin.update.text': 'Dostępna jest wersja TRAVELOOP {version}. Używasz {current}.',
  ...
  'admin.update.dockerText': 'Twoja instancja TRAVELOOP działa w Dockerze. Aby zaktualizować do {version}, uruchom następujące polecenia na swoim serwerze:',
  ...
  'vacay.sharingHint': 'Udostępnij swój plan urlopów innym użytkownikom TRAVELOOP',
  'vacay.owner': 'Właściciel',
  'vacay.shareEmailPlaceholder': 'E-mail użytkownika TRAVELOOP',
  ...
  'vacay.inviteHint': 'Zaproś innego użytkownika TRAVELOOP do wspólnego kalendarza urlopów.',
  ...
  'journey.pdf.madeWith': 'Stworzone z TRAVELOOP',
  ...
  // System notices
  'system_notice.welcome_v1.title': 'Witaj w TRAVELOOP',
  ...
  'system_notice.welcome_v1.hero_alt': 'Malownicze miejsce z interfejsem planowania TRAVELOOP',
  ...
  'system_notice.v3_photos.body': '**Zdjęcia** w Planerze Podróży zostały usunięte. Twoje zdjęcia są bezpieczne — TRAVELOOP nigdy nie modyfikował Twojej biblioteki Immich lub Synology.\n\nZdjęcia są teraz dostępne w dodatku **Journey**. Journey jest opcjonalny — jeśli jeszcze nie jest dostępny, poproś administratora o jego włączenie w Admin → Dodatki.',
  ...
  'system_notice.v3_mcp.highlight_deprecated': 'Statyczne tokeny traveloop_ przestarzałe',
  ...
  'system_notice.v3_thankyou.body': 'Zanim pójdziesz dalej — chcę się na chwilę zatrzymać.\n\nTRAVELOOP zaczął się jako poboczny projekt, który zbudowałem na własne podróże. Nigdy nie wyobrażałem sobie, że wyrośnie na coś, czemu 4000 z was ufa przy planowaniu swoich przygód. Każda gwiazdka, każdy issue, każda prośba o funkcję — czytam je wszystkie i to one trzymają mnie na nogach podczas późnych nocy między pracą na pełny etat a uczelnią.\n\nChcę, żebyście wiedzieli: TRAVELOOP zawsze będzie open source, zawsze self-hosted, zawsze wasz. Bez śledzenia, bez subskrypcji, bez haczyków. Po prostu narzędzie zbudowane przez kogoś, kto kocha podróżowanie tak samo jak wy.\n\nSzczególne podziękowania dla [jubnl](https://github.com/jubnl) — stałeś się niesamowitym współpracownikiem. Tak wiele z tego, co czyni wersję 3.0 wspaniałą, nosi twój ślad. Dziękuję, że uwierzyłeś w ten projekt, gdy był jeszcze surowy.\n\nI każdemu z was, kto zgłosił błąd, przetłumaczył tekst, podzielił się TRAVELOOP z przyjacielem lub po prostu użył go do zaplanowania podróży — **dziękuję**. To wy jesteście powodem, dla którego to istnieje.\n\nZa wiele kolejnych wspólnych przygód.\n\n— Maurice\n\n---\n\n[Dołącz do społeczności na Discordzie](https://discord.gg/7Q6M6jDwzf)\n\nJeśli TRAVELOOP sprawia, że Twoje podróże są lepsze, [mała kawa](https://ko-fi.com/mauriceboe) zawsze pomaga utrzymać światła włączone.',
