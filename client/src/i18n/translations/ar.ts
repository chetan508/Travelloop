...
const ar: Record<string, string | { name: string; category: string }[]> = {
  ...
  'settings.about.supporters.title': 'رفاق رحلة TRAVELOOP',
  'settings.about.supporters.subtitle': 'بينما تخطّط لمسارك التالي، يساعد هؤلاء الأشخاص في التخطيط لمستقبل TRAVELOOP. تذهب مساهمتهم الشهرية مباشرةً إلى التطوير والساعات الفعلية المبذولة — حتى يظلّ TRAVELOOP مفتوح المصدر.',
  ...
  'login.createAdminHint': 'أعد إعداد أول حساب مسؤول لـ TRAVELOOP.',
  ...
  'admin.addons.subtitle': 'فعّل أو عطّل الميزات لتخصيص تجربة TRAVELOOP.',
  ...
  'admin.weather.description': 'يستخدم TRAVELOOP خدمة Open-Meteo كمصدر لبيانات الطقس. وهي خدمة مجانية ومفتوحة المصدر ولا تتطلب مفتاح API.',
  ...
  'admin.github.support': 'يساعدني في تطوير TRAVELOOP',
  ...
  'admin.update.confirmText': 'سيتم تحديث TRAVELOOP من {current} إلى {version}. سيُعاد تشغيل الخادم تلقائيًا بعد ذلك.',
  ...
  'admin.update.dockerText': 'يعمل TRAVELOOP الخاص بك في Docker. للتحديث إلى {version}، نفّذ الأوامر التالية على الخادم:',
  ...
  'vacay.sharingHint': 'شارك خطة إجازاتك مع مستخدمي TRAVELOOP الآخرين',
  'vacay.owner': 'المالك',
  'vacay.shareEmailPlaceholder': 'البريد الإلكتروني لمستخدم TRAVELOOP',
  ...
  'vacay.inviteHint': 'ادعُ مستخدم TRAVELOOP آخرًا لمشاركة تقويم إجازة مشترك.',
  ...
  // System notices
  'system_notice.welcome_v1.title': 'مرحبًا بك في TRAVELOOP',
  ...
  'system_notice.welcome_v1.hero_alt': 'وجهة سفر خلابة مع واجهة تطبيق TRAVELOOP',
  ...
  'system_notice.v3_photos.body': 'تمت إزالة تبويب ​**الصور**​ من مخطط الرحلة. صورك آمنة — لم يعدّل TRAVELOOP مكتبتك على Immich أو Synology قطّ.\n\nتعيش الصور الآن في إضافة **Journey**. Journey اختيارية — إن لم تكن متاحة بعد، اطلب من المسؤول تفعيلها عبر Admin ← الإضافات.',
  ...
  'system_notice.v3_mcp.highlight_deprecated': 'الرموز الثابتة traveloop_ مهملة',
  ...
  'system_notice.v3_thankyou.body': 'قبل أن تمضي — أريد أن أتوقف لحظة.\n\nبدأ TRAVELOOP كمشروع جانبي بنيته لرحلاتي الخاصة. لم أتخيل يومًا أنه سيكبر ليصبح شيئًا يعتمد عليه 4,000 منكم لتخطيط مغامراتهم. كل نجمة، كل مشكلة، كل طلب ميزة — أقرأها جميعًا، وهي ما يبقيني مستمرًا في الليالي المتأخرة بين عمل بدوام كامل والجامعة.\n\nأريدكم أن تعرفوا: TRAVELOOP سيبقى دائمًا مفتوح المصدر، دائمًا مستضافًا ذاتيًا، دائمًا ملككم. لا تتبع، لا اشتراكات، لا شروط خفية. مجرد أداة بناها شخص يحب السفر بقدر ما تحبونه.\n\nشكر خاص لـ [jubnl](https://github.com/jubnl) — لقد أصبحت متعاونًا رائعًا. الكثير مما يجعل الإصدار 3.0 عظيمًا يحمل بصماتك. شكرًا لإيمانك بهذا المشروع عندما كان لا يزال في بداياته.\n\nولكل واحد منكم ممن أبلغ عن خطأ، أو ترجم نصًا، أو شارك TRAVELOOP مع صديق، أو ببساطة استخدمه لتخطيط رحلة — **شكرًا لكم**. أنتم السبب في وجود هذا.\n\nإلى المزيد من المغامرات معًا.\n\n— Maurice\n\n---\n\n[انضم إلى المجتمع على Discord](https://discord.gg/7Q6M6jDwzf)\n\nإذا جعل TRAVELOOP رحلاتك أفضل، [فنجان قهوة صغير](https://ko-fi.com/mauriceboe) يبقي الأضواء مشتعلة.',
