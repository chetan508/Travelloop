const hu: Record<string, string | { name: string; category: string }[]> = {
  ...
  'settings.about.supporters.title': 'Útitársak a TRAVELOOP mellett',
  'settings.about.supporters.subtitle': 'Miközben te a következő útvonaladat tervezed, ők a TRAVELOOP jövőjét tervezik velem együtt. Havi hozzájárulásuk közvetlenül fejlesztésre és valódi órákra fordítódik — hogy a TRAVELOOP Open Source maradhasson.',
  ...
  'settings.about.description': 'A TRAVELOOP egy saját szerveren üzemeltetett útitervező, amely segít az utazásaid megszervezésében az első ötlettől az utolsó emlékig. Napi tervezés, költségvetés, csomagolási listák, fotók és még sok más — minden egy helyen, a saját szervereden.',
  ...
  'login.createAdminHint': 'Hozd létre az első admin fiókot a TRAVELOOP-hez.',
  ...
  'admin.addons.subtitle': 'Funkciók engedélyezése vagy letiltása a TRAVELOOP testreszabásához.',
  ...
  'admin.weather.description': 'A TRAVELOOP az Open-Meteo-t használja időjárás-adatforrásként. Az Open-Meteo egy ingyenes, nyílt forráskódú időjárás-szolgáltatás — nincs szükség API kulcsra.',
  ...
  'admin.github.support': 'Segít fenntartani a TRAVELOOP fejlesztését',

  'admin.update.available': 'Frissítés elérhető',
  'admin.update.text': 'A TRAVELOOP {version} elérhető. Jelenleg a {current} verziót használod.',
  ...
  'admin.update.confirmText': 'A TRAVELOOP frissítésre kerül {current} verzióról {version} verzióra. A szerver ezután automatikusan újraindul.',
  ...
  'admin.update.dockerText': 'A TRAVELOOP példányod Dockerben fut. A {version} verzióra frissítéshez futtasd a következő parancsokat a szervereden:',
  ...
  'vacay.sharingHint': 'Szabadságterved megosztása más TRAVELOOP felhasználókkal',
  ...
  'vacay.inviteHint': 'Hívj meg egy másik TRAVELOOP felhasználót közös szabadságnaptár megosztásához.',
  ...
  'notifications.versionAvailable.text': 'A TRAVELOOP {version} már elérhető.',
  ...
  'notif.version_available.text': 'A TRAVELOOP {version} elérhető',
  ...
  'journey.pdf.madeWith': 'Készítve a TRAVELOOP segítségével',
  'journey.pdf.day': 'Nap',
  ...
  // System notices
  'system_notice.welcome_v1.title': 'Üdvözöl a TRAVELOOP',
  ...
  'system_notice.welcome_v1.hero_alt': 'Festői úticél TRAVELOOP tervező felülettel',
  ...
  'system_notice.v3_photos.body': 'Az útiterv-tervező **Fényképek** lapja eltávolításra került. Fényképeid biztonságban vannak — TRAVELOOP soha nem módosította Immich vagy Synology könyvtáradat.\n\nA fényképek mostantól a **Journey** bővítményben élnek. A Journey opcionális — ha még nem elérhető, kérd meg a rendszergazdát, hogy engedélyezze Admin → Bővítmények alatt.',
  ...
  'system_notice.v3_mcp.highlight_deprecated': 'Statikus traveloop_ tokenek elavultak',
  ...
  'system_notice.v3_thankyou.body': 'Mielőtt továbbmennél — szeretnék egy pillanatra megállni.\n\nA TRAVELOOP egy hobbiprojektként indult, amit a saját utazásaimhoz építettem. Sosem gondoltam volna, hogy valami olyanná nő, amire 4000-en bízzátok a kalandjaitok tervezését. Minden csillagot, minden issue-t, minden funkciókérést — mindet elolvasom, és ezek tartanak életben a késő éjszakákon a teljes állás és az egyetem között.\n\nSzeretnétek, ha tudnátok: a TRAVELOOP mindig nyílt forráskódú marad, mindig self-hosted, mindig a tiétek. Nincs nyomkövetés, nincs előfizetés, nincsenek rejtett feltételek. Csak egy eszköz, amit valaki épített, aki ugyanúgy szereti az utazást, mint ti.\n\nKülönleges köszönet [jubnl](https://github.com/jubnl)-nek — hihetetlen társsá váltál. A 3.0 nagyszerűségének nagy része a te kézjegyedet viseli. Köszönöm, hogy hittél ebben a projektben, amikor még nyers volt.\n\nÉs mindannyiótoknak, akik hibát jelentettetek, szöveget fordítottatok, megosztottátok a TRAVELOOP-et egy baráttal, vagy egyszerűen csak egy utazást terveztetek vele — **köszönöm**. Ti vagytok az ok, amiért ez létezik.\n\nSok további közös kalandért.\n\n— Maurice\n\n---\n\n[Csatlakozz a közösséghez a Discordon](https://discord.gg/7Q6M6jDwzf)\n\nHa a TRAVELOOP jobbá teszi az utazásaidat, egy [kis kávé](https://ko-fi.com/mauriceboe) mindig segít, hogy égve maradjanak a fények.',
