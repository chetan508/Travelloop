...
The **GitHub** tab shows the TRAVELOOP release history fetched from GitHub and provides links to community resources and support options.
...
| **Discord** | Join the TRAVELOOP community |
...
Below the support cards, a chronological timeline lists GitHub releases for the `mauriceboe/TRAVELOOP` repository. Each entry shows:
