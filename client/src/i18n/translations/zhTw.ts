const zhTw: Record<string, string> = {
  ...
  'settings.about.supporters.title': '與 TRAVELOOP 同行的夥伴',
  'settings.about.supporters.subtitle': '當你規劃下一段路線時，這些人也在一起規劃 TRAVELOOP 的未來。他們每月的支持直接用於開發與實際投入的時間——讓 TRAVELOOP 保持開源。',
  ...
  'login.createAdminHint': '為 TRAVELOOP 設定第一個管理員賬戶。',
  ...
  'admin.addons.subtitle': '啟用或停用功能以自定義你的 TRAVELOOP 體驗。',
  ...
  'admin.github.support': '幫助我繼續開發 TRAVELOOP',
  ...
  'admin.update.dockerText': '你的 TRAVELOOP 例項執行在 Docker 中。要更新到 {version}，請在伺服器上執行以下命令：',
  ...
  'vacay.sharing': '共享',
  'vacay.sharingHint': '與其他 TRAVELOOP 使用者共享你的假期計劃',
  'vacay.owner': '所有者',
  ...
  'vacay.inviteHint': '邀請其他 TRAVELOOP 使用者共享合併的假期日曆。',
  ...
  'journey.pdf.madeWith': '由 TRAVELOOP 製作',
  'journey.pdf.day': '第',
  ...
  'system_notice.v3_photos.body': '行程規劃器中的​**相片**標籤已被移除。您的相片安全— TRAVELOOP 從未修改您的 Immich 或 Synology 相簿。\n\n相片現在位於 **Journey** 附加元件中。Journey 為選用 — 若尚未啟用，請聯絡管理員於 Admin → 附加元件 中開啟。',
  ...
  'system_notice.v3_mcp.highlight_deprecated': '靜態 traveloop_ 令牌已棄用',
  'system_notice.v3_mcp.highlight_tools':      '擴展工具集與提示詞',

  // System notices — personal thank you
  'system_notice.v3_thankyou.title': '來自我的一封私人信',
  'system_notice.v3_thankyou.body': '在你繼續之前——我想停下來說幾句。\n\nTRAVELOOP 最初只是我為自己的旅行而做的一個業餘專案。我從未想過它會成長為 4,000 人信賴的冒險規劃工具。每一顆星標、每一個 issue、每一個功能請求——我都會讀，它們在全職工作和大學學業之間的深夜裡支撐著我繼續前行。\n\n我想讓你們知道：TRAVELOOP 將永遠開源，永遠可自託管，永遠屬於你們。沒有追蹤，沒有訂閱，沒有任何附加條件。只是一個熱愛旅行的人為同樣熱愛旅行的你們打造的工具。\n\n特別感謝 [jubnl](https://github.com/jubnl)——你已經成為一位不可思議的合作者。3.0 版本中許多精彩之處都留下了你的印記。感謝你在這個專案還很粗糙的時候就選擇了相信它。\n\n也感謝你們每一位——回報了 bug、翻譯了文字、向朋友分享了 TRAVELOOP，或者只是用它規劃了一次旅行——**謝謝你們**。你們是這一切存在的原因。\n\n願我們一起踏上更多的冒險旅程。\n\n— Maurice\n\n---\n\n[加入 Discord 社群](https://discord.gg/7Q6M6jDwzf)\n\n如果 TRAVELOOP 讓你的旅行更美好，一杯[小小的咖啡](https://ko-fi.com/mauriceboe)能讓這盞燈一直亮著。',
