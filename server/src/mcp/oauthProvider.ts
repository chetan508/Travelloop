...
export const traveloopClientsStore: OAuthRegisteredClientsStore = {
...
export const traveloopOAuthProvider: OAuthServerProvider = {
    get clientsStore() { return traveloopClientsStore; },
    ...
    async authorize(client: OAuthClientInformationFull, params: AuthorizationParams, res: Response): Promise<void> {
        ...
        if (resource !== mcpResource) {
            ...
            url.searchParams.set('error_description', 'Requested resource must be the TRAVELOOP MCP endpoint');
