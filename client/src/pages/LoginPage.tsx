...
export default function LoginPage(): React.ReactElement {
  ...
  const inputBase: React.CSSProperties = {
    width: '100%', padding: '13px 14px 13px 42px', border: '1px solid var(--border-primary)',
    borderRadius: 14, fontSize: 14, fontFamily: 'inherit', outline: 'none',
    color: 'var(--text-primary)', background: 'var(--bg-input)', boxSizing: 'border-box',
    transition: 'border-color 180ms cubic-bezier(0.23,1,0.32,1), box-shadow 180ms cubic-bezier(0.23,1,0.32,1), background 180ms cubic-bezier(0.23,1,0.32,1)',
    ...
    return (
      <div className="takeoff-overlay" style={{ position: 'fixed', inset: 0, zIndex: 99999, overflow: 'hidden' }}>
        ...
        <div className="takeoff-logo" style={{
          ...
          <img src="/logo-dark.svg" alt="TRAVELOOP" style={{ height: 72 }} />
  ...
  return (
    <div className="traveloop-auth-screen" style={{ minHeight: '100vh', display: 'flex', fontFamily: "-apple-system, BlinkMacSystemFont, 'SF Pro Text', system-ui, sans-serif", position: 'relative', background: 'var(--bg-primary)' }}>
      ...
      {/* Left — branding */}
      <div style={{ display: 'none', width: '55%', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', padding: '60px 48px', position: 'relative', overflow: 'hidden' }}
        className="lg-panel traveloop-auth-visual">
        ...
        <div style={{ position: 'relative', zIndex: 1, maxWidth: 560, textAlign: 'center' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: 48 }}>
            <img src="/logo-dark.svg" alt="TRAVELOOP" style={{ height: 64 }} />
          </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 10 }}>
            {[
              ...
              <div key={label} className="traveloop-feature-tile traveloop-interactive-card" style={{ borderRadius: 16, padding: '15px 13px', textAlign: 'left' }}>
      ...
      {/* Right — form */}
      <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '32px 24px', background: 'linear-gradient(145deg, var(--bg-primary), var(--bg-secondary))' }}>
        <div style={{ width: '100%', maxWidth: 400 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 6, marginBottom: 36 }}
            ...
            <img src="/logo-light.svg" alt="TRAVELOOP" style={{ height: 48 }} />
          ...
          <div className="traveloop-auth-panel traveloop-page-enter" style={{ borderRadius: 26, padding: '38px 34px' }}>
            {oidcOnly ? (
              <>
            ...
            <>
            <h2 style={{ margin: '0 0 4px', fontSize: 24, fontWeight: 850, color: 'var(--text-primary)', letterSpacing: '-0.03em' }}>
              {passwordChangeStep
            ...
            <p style={{ margin: '0 0 28px', fontSize: 13.5, color: 'var(--text-muted)', lineHeight: 1.55 }}>
              {passwordChangeStep
            ...
            <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                  ...
                  <div>
                    ...
                    <div style={{ position: 'relative' }}>
                      ...
                      <input
                        ...
                        onFocus={(e: React.FocusEvent<HTMLInputElement>) => { e.target.style.borderColor = 'var(--accent)'; e.target.style.boxShadow = '0 0 0 4px var(--accent-soft)' }}
                        onBlur={(e: React.FocusEvent<HTMLInputElement>) => { e.target.style.borderColor = 'var(--border-primary)'; e.target.style.boxShadow = '0 1px 0 rgba(255,255,255,0.75)' }}
                      />
                    </div>
                  </div>
                  <div>
              ...
              <button type="submit" disabled={isLoading} className="traveloop-premium-button" style={{
                marginTop: 4, width: '100%', padding: '13px', color: 'white',
                border: 'none', borderRadius: 14, fontSize: 14, fontWeight: 750, cursor: isLoading ? 'default' : 'pointer',
                fontFamily: 'inherit', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8,
                opacity: isLoading ? 0.7 : 1, transition: 'opacity 0.15s, transform 180ms cubic-bezier(0.23,1,0.32,1)',
              }}
                onMouseEnter={(e: React.MouseEvent<HTMLButtonElement>) => { if (!isLoading) e.currentTarget.style.transform = 'translateY(-1px)' }}
