...
describe('AdminMcpTokensPanel', () => {
  ...
  it('FE-ADMIN-MCP-003: token list renders correctly', async () => {
    ...
    expect(screen.getByText(/traveloop_abc/)).toBeInTheDocument();
    expect(screen.getByText(/traveloop_xyz/)).toBeInTheDocument();
  });
