const id: Record<string, string | { name: string; category: string }[]> = {
  ...
  'settings.about.supporters.title': 'Rekan perjalanan untuk TRAVELOOP',
  'settings.about.supporters.subtitle': 'Saat kamu merencanakan rute berikutnya, orang-orang ini ikut merencanakan masa depan TRAVELOOP. Kontribusi bulanan mereka langsung masuk ke pengembangan dan jam kerja nyata — supaya TRAVELOOP tetap Open Source.',
  ...
  'login.createAdminHint': 'Siapkan akun admin pertama untuk TRAVELOOP.',
  ...
  'admin.addons.subtitle': 'Aktifkan atau nonaktifkan fitur untuk menyesuaikan pengalaman TRAVELOOP kamu.',
  ...
  'admin.github.support': 'Bantu saya terus mengembangkan TRAVELOOP',
  ...
  'admin.update.dockerText': 'Instans TRAVELOOP kamu berjalan di Docker. Untuk memperbarui ke {version}, jalankan perintah berikut di servermu:',
  ...
  'vacay.sharingHint': 'Bagikan rencana cuti kamu dengan pengguna TRAVELOOP lainnya',
  'vacay.owner': 'Pemilik',
  'vacay.shareEmailPlaceholder': 'Email pengguna TRAVELOOP',
  ...
  'vacay.inviteHint': 'Undang pengguna TRAVELOOP lain untuk berbagi kalender cuti bersama.',
  ...
  'places.gpxImportTracks': 'TRAVELOOP (dengan geometri jalur)',
  ...
  'journey.pdf.madeWith': 'Dibuat dengan TRAVELOOP',
  ...
  // System notices
  'system_notice.welcome_v1.title': 'Selamat datang di TRAVELOOP',
  ...
  'system_notice.welcome_v1.hero_alt': 'Destinasi wisata indah dengan antarmuka TRAVELOOP',
  ...
  'system_notice.v3_photos.body': '**Foto** di Perencana Perjalanan telah dihapus. Foto Anda aman — TRAVELOOP tidak pernah mengubah perpustakaan Immich atau Synology Anda.\n\nFoto kini ada di addon **Journey**. Journey bersifat opsional — jika belum tersedia, minta admin untuk mengaktifkannya di Admin → Addon.',
  ...
  'system_notice.v3_mcp.highlight_deprecated': 'Token statis traveloop_ sudah usang',
