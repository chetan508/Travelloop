const de: Record<string, string | { name: string; category: string }[]> = {
  ...
  'settings.about.supporters.title': 'Reisebegleitung für TRAVELOOP',
  'settings.about.supporters.subtitle': 'Während du deine nächste Route planst, planen diese Leute mit, wie TRAVELOOP weitergeht. Ihr monatlicher Beitrag fließt direkt in Entwicklung und echten Zeitaufwand — damit TRAVELOOP Open Source bleibt.',
  ...
  'login.createAdminHint': 'Erstelle das erste Admin-Konto für TRAVELOOP.',
  ...
  'admin.addons.subtitle': 'Aktiviere oder deaktiviere Funktionen, um TRAVELOOP nach deinen Wünschen anzupassen.',
  ...
  'admin.github.by': 'von',
  'admin.github.support': 'Hilft mir, TRAVELOOP weiterzuentwickeln',
  ...
  'admin.update.dockerText': 'Deine TRAVELOOP-Instanz läuft in Docker. Um auf {version} zu aktualisieren, führe folgende Befehle auf deinem Server aus:',
  ...
  'vacay.sharingHint': 'Teile deinen Urlaubsplan mit anderen TRAVELOOP-Benutzern',
  'vacay.owner': 'Besitzer',
  'vacay.shareEmailPlaceholder': 'E-Mail des TRAVELOOP-Benutzers',
  ...
  'vacay.inviteHint': 'Lade einen anderen TRAVELOOP-Benutzer ein, um einen gemeinsamen Urlaubskalender zu teilen.',
  ...
  'journey.pdf.madeWith': 'Erstellt mit TRAVELOOP',
  'journey.pdf.day': 'Tag',
  ...
  // System notices
  'system_notice.welcome_v1.title': 'Willkommen bei TRAVELOOP',
  ...
  'system_notice.welcome_v1.hero_alt': 'Malerisches Reiseziel mit TRAVELOOP-Planungs-UI',
  ...
  'system_notice.v3_photos.body': '**Fotos** im Trip-Planer wurden entfernt. Deine Fotos sind sicher — TRAVELOOP hat deine Immich- oder Synology-Bibliothek nie verändert.\n\nFotos befinden sich jetzt im **Journey**-Addon. Journey ist optional — falls es noch nicht verfügbar ist, bitte deinen Admin, es unter Admin → Addons zu aktivieren.',
  ...
  'system_notice.v3_mcp.highlight_deprecated': 'Statische traveloop_-Tokens veraltet',
