...
export function Skeleton({
  ...
  return (
    <div
      className={`traveloop-skeleton ${className ?? ''}`.trim()}
      style={{
        width,
        height: height ?? 14,
...
export function SpotlightSkeleton(): React.ReactElement {
  return (
    <div
      ...
      style={{ minHeight: 340, background: 'var(--bg-tertiary)', boxShadow: 'var(--shadow-card)' }}
    >
      <div className="traveloop-skeleton absolute inset-0" style={{ borderRadius: 24 }} />
