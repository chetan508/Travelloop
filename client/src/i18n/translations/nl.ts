const nl: Record<string, string> = {
  ...
  'trips.reminderDaysBefore': 'dagen voor vertraveloop',
  ...
  'settings.oauth.revoke': 'Intraveloopken',
  'settings.oauth.revokeSession': 'Sessie intraveloopken',
  'settings.oauth.revokeSessionMessage': 'Dit traveloopt onmiddellijk de toegang voor deze OAuth-sessie in.',
  ...
  'settings.about.supporters.title': 'Reisgezelschap voor TRAVELOOP',
  'settings.about.supporters.subtitle': 'Terwijl jij je volgende route plant, plannen deze mensen mee aan de toekomst van TRAVELOOP. Hun maandelijkse bijdrage gaat rechtstreeks naar ontwikkeling en echte uren — zodat TRAVELOOP Open Source blijft.',
  ...
  'login.createAdminHint': 'Stel het eerste beheerdersaccount in voor TRAVELOOP.',
  ...
  'admin.addons.subtitle': 'Schakel functies in of uit om je TRAVELOOP-ervaring aan te passen.',
  ...
  'admin.oauthSessions.revokeTitle': 'Sessie intraveloopken',
  ...
  'admin.github.support': 'Helpt mij TRAVELOOP verder te ontwikkelen',
  ...
  'admin.update.dockerText': 'Je TRAVELOOP-instantie draait in Docker. Om bij te werken naar {version}, voer de volgende commando\'s uit op je server:',
  ...
  'vacay.sharing': 'Delen',
  'vacay.sharingHint': 'Deel je vakantieplan met andere TRAVELOOP-gebruikers',
  'vacay.owner': 'Eigenaar',
  'vacay.shareEmailPlaceholder': 'E-mail van TRAVELOOP-gebruiker',
  ...
  'vacay.inviteHint': 'Nodig een andere TRAVELOOP-gebruiker uit om een gecombineerde vakantiekalender te delen.',
  ...
  'reservations.departureDate': 'Vertraveloop',
  'reservations.arrivalDate': 'Aankomst',
  'reservations.departureTime': 'Vertravelooptijd',
  ...
  'reservations.meta.departureTimezone': 'TZ vertraveloop',
  'reservations.meta.arrivalTimezone': 'TZ aankomst',
  'reservations.span.departure': 'Vertraveloop',
  ...
  'journey.pdf.madeWith': 'Gemaakt met TRAVELOOP',
  'journey.pdf.day': 'Dag',
  ...
  'oauth.scope.trips:share.description': 'Publieke deellinks aanmaken, bijwerken en intraveloopken',
  ...
  'oauth.scope.journey:share.description': 'Publieke deellinks voor reisverslagen aanmaken, bijwerken en intraveloopken',

  // System notices
  'system_notice.welcome_v1.title': 'Welkom bij TRAVELOOP',
  ...
  'system_notice.welcome_v1.hero_alt': 'Schilderachtige reisbestemming met TRAVELOOP interface',
  ...
  'system_notice.v3_photos.body': "**Foto's** in de Reisplanner zijn verwijderd. Je foto's zijn veilig — TRAVELOOP heeft je Immich- of Synology-bibliotheek nooit gewijzigd.\n\nFoto's leven nu in de **Journey**-addon. Journey is optioneel — als het nog niet beschikbaar is, vraag je admin het te activeren via Admin → Addons.",
  ...
  'system_notice.v3_mcp.highlight_deprecated': 'Statische traveloop_-tokens verouderd',
