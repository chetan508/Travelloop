...
const PlacesSidebar = React.memo(function PlacesSidebar({
  ...
  return (
    ...
    >
      ...
      {/* Liste */}
      <div className="traveloop-stagger" style={{ flex: 1, overflowY: 'auto', minHeight: 0 }} ref={scrollContainerRef} onScroll={(e) => onScrollTopChange?.((e.currentTarget as HTMLElement).scrollTop)}>
        {filtered.length === 0 ? (
