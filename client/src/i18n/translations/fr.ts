const fr: Record<string, string> = {
  ...
  'settings.about.supporters.title': 'Compagnons de voyage pour TRAVELOOP',
  'settings.about.supporters.subtitle': 'Pendant que tu planifies ton prochain itinéraire, ces personnes aident à planifier l\'avenir de TRAVELOOP. Leur contribution mensuelle va directement au développement et aux heures réellement passées — pour que TRAVELOOP reste Open Source.',
  ...
  'login.createAdminHint': 'Configurez le premier compte administrateur pour TRAVELOOP.',
  ...
  'admin.addons.subtitle': 'Activez ou désactivez des fonctionnalités pour personnaliser votre expérience TRAVELOOP.',
  ...
  'admin.github.support': 'Aidez à poursuivre le développement de TRAVELOOP',
  ...
  'admin.update.dockerText': 'Votre instance TRAVELOOP fonctionne dans Docker. Pour mettre à jour vers {version}, exécutez les commandes suivantes sur votre serveur :',
  ...
  'vacay.sharingHint': 'Partagez votre plan de vacances avec d\'autres utilisateurs TRAVELOOP',
  'vacay.owner': 'Propriétaire',
  'vacay.shareEmailPlaceholder': 'E-mail de l\'utilisateur TRAVELOOP',
  ...
  'vacay.inviteHint': 'Invitez un autre utilisateur TRAVELOOP à partager un calendrier de vacances combiné.',
  ...
  'journey.pdf.madeWith': 'Créé avec TRAVELOOP',
  ...
  // System notices
  'system_notice.welcome_v1.title': 'Bienvenue sur TRAVELOOP',
  ...
  'system_notice.welcome_v1.hero_alt': 'Destination de voyage pittoresque avec l\'interface TRAVELOOP',
  ...
  'system_notice.v3_photos.body': "**Photos** dans le planificateur ont été supprimées. Tes photos sont en sécurité — TRAVELOOP n'a jamais modifié ta bibliothèque Immich ou Synology.\n\nLes photos vivent désormais dans l'addon **Journey**. Journey est optionnel — s'il n'est pas encore disponible, demande à ton admin de l'activer dans Admin → Modules.",
  ...
  'system_notice.v3_mcp.body': "L'intégration MCP a été entièrement repensée. OAuth 2.1 est désormais la méthode d'authentification recommandée. Les tokens statiques (traveloop_\u2026) sont dépréciés et seront supprimés dans une future version.",
  ...
  'system_notice.v3_mcp.highlight_deprecated': 'Tokens statiques traveloop_ dépréciés',
  ...
  'system_notice.v3_thankyou.body': 'Avant de continuer — je veux prendre un instant.\n\nTRAVELOOP a commencé comme un projet perso que j\'ai construit pour mes propres voyages. Je n\'aurais jamais imaginé qu\'il grandirait au point que 4 000 d\'entre vous lui fassent confiance pour planifier vos aventures. Chaque étoile, chaque issue, chaque demande de fonctionnalité — je les lis toutes, et ce sont elles qui me font tenir pendant les nuits blanches entre un travail à temps plein et l\'université.\n\nJe veux que vous sachiez : TRAVELOOP sera toujours open source, toujours auto-hébergé, toujours à vous. Pas de tracking, pas d\'abonnements, pas de conditions cachées. Juste un outil construit par quelqu\'un qui aime voyager autant que vous.\n\nUn merci tout particulier à [jubnl](https://github.com/jubnl) — tu es devenu un collaborateur incroyable. Une grande partie de ce qui rend la 3.0 géniale porte ton empreinte. Merci d\'avoir cru en ce projet quand il était encore brut.\n\nEt à chacun d\'entre vous qui a signalé un bug, traduit une chaîne, partagé TRAVELOOP avec un ami ou simplement l\'a utilisé pour planifier un voyage — **merci**. Vous êtes la raison pour laquelle tout ceci existe.\n\nÀ de nombreuses autres aventures ensemble.\n\n— Maurice\n\n---\n\n[Rejoins la communauté sur Discord](https://discord.gg/7Q6M6jDwzf)\n\nSi TRAVELOOP rend tes voyages meilleurs, un [petit café](https://ko-fi.com/mauriceboe) aide toujours à garder les lumières allumées.',
