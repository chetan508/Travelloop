const br: Record<string, string | { name: string; category: string }[]> = {
  ...
  'settings.about.supporters.title': 'Companheiros de viagem do TRAVELOOP',
  'settings.about.supporters.subtitle': 'Enquanto você planeja sua próxima rota, essas pessoas planejam junto o futuro do TRAVELOOP. A contribuição mensal delas vai direto para o desenvolvimento e horas reais investidas — para o TRAVELOOP continuar Open Source.',
  ...
  'login.createAdminHint': 'Configure a primeira conta de administrador do TRAVELOOP.',
  ...
  'admin.addons.subtitle': 'Ative ou desative recursos para personalizar sua experiência no TRAVELOOP.',
  ...
  'admin.weather.description': 'O TRAVELOOP usa Open-Meteo como fonte de clima. Open-Meteo é um serviço gratuito e de código aberto — sem chave de API.',
  ...
  'admin.github.by': 'por',
  'admin.github.support': 'Ajuda a continuar desenvolvendo o TRAVELOOP',

  'admin.update.available': 'Atualização disponível',
  'admin.update.text': 'O TRAVELOOP {version} está disponível. Você está na {current}.',
  'admin.update.button': 'Ver no GitHub',
  'admin.update.install': 'Instalar atualização',
  'admin.update.confirmTitle': 'Instalar atualização?',
  'admin.update.confirmText': 'O TRAVELOOP será atualizado de {current} para {version}. O servidor reiniciará automaticamente em seguida.',
  ...
  'admin.update.dockerText': 'Sua instância TRAVELOOP roda no Docker. Para atualizar para {version}, execute no servidor:',
  ...
  'vacay.sharingHint': 'Compartilhe seu plano de férias com outros usuários do TRAVELOOP',
  'vacay.owner': 'Proprietário',
  'vacay.shareEmailPlaceholder': 'E-mail do usuário TRAVELOOP',
  ...
  'vacay.inviteHint': 'Convide outro usuário TRAVELOOP para compartilhar um calendário de férias combinado.',
  ...
  'journey.pdf.madeWith': 'Feito com TRAVELOOP',
  'journey.pdf.day': 'Dia',
  ...
  // System notices
  'system_notice.welcome_v1.title': 'Bem-vindo ao TRAVELOOP',
  ...
  'system_notice.welcome_v1.hero_alt': 'Destino de viagem pitoresco com a interface do TRAVELOOP',
  ...
  'system_notice.v3_photos.body': '**Fotos** no Planejador de Viagens foram removidas. Suas fotos estão seguras — o TRAVELOOP nunca modificou sua biblioteca Immich ou Synology.\n\nAs fotos agora vivem no addon **Journey**. Journey é opcional — se ainda não estiver disponível, peça ao seu admin para ativá-lo em Admin → Addons.',
  ...
  'system_notice.v3_mcp.highlight_deprecated': 'Tokens estáticos traveloop_ descontinuados',
  ...
  'system_notice.v3_thankyou.body': 'Antes de seguir em frente — quero fazer uma pausa.\n\nO TRAVELOOP começou como um projeto paralelo que criei para minhas próprias viagens. Nunca imaginei que cresceria a ponto de 4.000 de vocês confiarem nele para planejar suas aventuras. Cada estrela, cada issue, cada pedido de recurso — eu leio todos, e eles me mantêm firme nas noites longas entre um trabalho em tempo integral e a universidade.\n\nQuero que saibam: o TRAVELOOP sempre será open source, sempre self-hosted, sempre de vocês. Sem rastreamento, sem assinaturas, sem pegadinhas. Apenas uma ferramenta feita por alguém que ama viajar tanto quanto vocês.\n\nAgradecimento especial ao [jubnl](https://github.com/jubnl) — você se tornou um colaborador incrível. Muito do que torna a versão 3.0 especial tem a sua marca. Obrigado por acreditar neste projeto quando ele ainda era bem cru.\n\nE a cada um de vocês que reportou um bug, traduziu uma string, compartilhou o TRAVELOOP com um amigo ou simplesmente o usou para planejar uma viagem — **obrigado**. Vocês são a razão de tudo isso existir.\n\nQue venham muitas mais aventuras juntos.\n\n— Maurice\n\n---\n\n[Junte-se à comunidade no Discord](https://discord.gg/7Q6M6jDwzf)\n\nSe o TRAVELOOP torna suas viagens melhores, um [cafezinho](https://ko-fi.com/mauriceboe) sempre mantém as luzes acesas.',
