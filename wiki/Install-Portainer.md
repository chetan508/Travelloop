...
Install TRAVELOOP on Portainer using a Stack (Docker Compose).
...
2. Give the stack a name (e.g. `traveloop`).
3. Select **Web editor** and paste the compose file from [docker-compose.yml](https://github.com/mauriceboe/TRAVELOOP/blob/main/docker-compose.yml).
