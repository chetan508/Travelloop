...
export function registerResources(server: McpServer, userId: number, scopes: string[] | null): void {
  ...
  if (canReadTrips(scopes)) server.registerResource(
    'trip',
    new ResourceTemplate('traveloop://trips/{tripId}', { list: undefined }),
  ...
  if (canReadTrips(scopes)) server.registerResource(
    'trip-days',
    new ResourceTemplate('traveloop://trips/{tripId}/days', { list: undefined }),
  ...
  if (canRead(scopes, 'places')) server.registerResource(
    'trip-places',
    new ResourceTemplate('traveloop://trips/{tripId}/places', { list: undefined }),
  ...
  if (isAddonEnabled(ADDON_IDS.BUDGET) && canRead(scopes, 'budget')) server.registerResource(
    'trip-budget',
    new ResourceTemplate('traveloop://trips/{tripId}/budget', { list: undefined }),
  ...
  if (isAddonEnabled(ADDON_IDS.PACKING) && canRead(scopes, 'packing')) server.registerResource(
    'trip-packing',
    new ResourceTemplate('traveloop://trips/{tripId}/packing', { list: undefined }),
  ...
  if (canRead(scopes, 'reservations')) server.registerResource(
    'trip-reservations',
    new ResourceTemplate('traveloop://trips/{tripId}/reservations', { list: undefined }),
  ...
  if (canReadTrips(scopes)) server.registerResource(
    'day-notes',
    new ResourceTemplate('traveloop://trips/{tripId}/days/{dayId}/notes', { list: undefined }),
  ...
  if (canReadTrips(scopes)) server.registerResource(
    'trip-accommodations',
    new ResourceTemplate('traveloop://trips/{tripId}/accommodations', { list: undefined }),
  ...
  if (canReadTrips(scopes)) server.registerResource(
    'trip-members',
    new ResourceTemplate('traveloop://trips/{tripId}/members', { list: undefined }),
  ...
  if (collabFeatures?.notes && canRead(scopes, 'collab')) server.registerResource(
    'trip-collab-notes',
    new ResourceTemplate('traveloop://trips/{tripId}/collab-notes', { list: undefined }),
  ...
  if (isAddonEnabled(ADDON_IDS.PACKING) && canRead(scopes, 'todos')) server.registerResource(
    'trip-todos',
    new ResourceTemplate('traveloop://trips/{tripId}/todos', { list: undefined }),
  ...
  if (isAddonEnabled(ADDON_IDS.BUDGET) && canRead(scopes, 'budget')) server.registerResource(
    ...
    new ResourceTemplate('traveloop://trips/{tripId}/budget/per-person', { list: undefined }),
  ...
  if (isAddonEnabled(ADDON_IDS.BUDGET) && canRead(scopes, 'budget')) server.registerResource(
    ...
    new ResourceTemplate('traveloop://trips/{tripId}/budget/settlement', { list: undefined }),
  ...
  if (isAddonEnabled(ADDON_IDS.PACKING) && canRead(scopes, 'packing')) server.registerResource(
    'trip-packing-bags',
    new ResourceTemplate('traveloop://trips/{tripId}/packing/bags', { list: undefined }),
  ...
  if (canRead(scopes, 'notifications')) server.registerResource(
    ...
    'traveloop://notifications/in-app',
  ...
  if (collabFeatures?.polls && canRead(scopes, 'collab')) {
    server.registerResource(
      'trip-collab-polls',
      new ResourceTemplate('traveloop://trips/{tripId}/collab/polls', { list: undefined }),
  ...
  if (collabFeatures?.chat && canRead(scopes, 'collab')) {
    server.registerResource(
      ...
      new ResourceTemplate('traveloop://trips/{tripId}/collab/messages', { list: undefined }),
  ...
  if (isAddonEnabled(ADDON_IDS.VACAY) && canRead(scopes, 'vacay')) {
    ...
    server.registerResource(
      'vacay-entries',
      new ResourceTemplate('traveloop://vacay/entries/{year}', { list: undefined }),
    ...
    server.registerResource(
      'vacay-holidays',
      new ResourceTemplate('traveloop://vacay/holidays/{year}', { list: undefined }),
  ...
  if (isAddonEnabled(ADDON_IDS.JOURNEY) && canRead(scopes, 'journey')) {
    ...
    server.registerResource(
      'journey-detail',
      new ResourceTemplate('traveloop://journeys/{journeyId}', { list: undefined }),
    ...
    server.registerResource(
      'journey-entries',
      new ResourceTemplate('traveloop://journeys/{journeyId}/entries', { list: undefined }),
    ...
    server.registerResource(
      ...
      new ResourceTemplate('traveloop://journeys/{journeyId}/contributors', { list: undefined }),
