  ...
  if (loading) {
    return (
      <div className="min-h-screen traveloop-app-shell">
        <AnimatedBackground />
        <Navbar />
        <div className="flex items-center justify-center" style={{ paddingTop: 'var(--nav-h)', minHeight: 'calc(100vh - var(--nav-h))', position: 'relative', zIndex: 1 }}>
            ...
            <div style={{
              ...
              <div style={{ display: 'inline-flex', gap: 6, alignItems: 'center', marginLeft: 'auto', flexShrink: 0 }}>
                <button
                  ...
                  className="traveloop-premium-button"
                >
      ...
      {incomingInvites.length > 0 && ReactDOM.createPortal(
        <div className="fixed inset-0 flex items-center justify-center px-4"
          ...
          {incomingInvites.map(inv => (
            <div key={inv.id} className="traveloop-modal-enter w-full max-w-md rounded-2xl shadow-2xl overflow-hidden"
