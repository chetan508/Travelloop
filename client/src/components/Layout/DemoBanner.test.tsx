...
describe('DemoBanner', () => {
  ...
  it('shows "What is TRAVELOOP?" section', () => {
    render(<DemoBanner />);
    expect(screen.getByText('What is TRAVELOOP?')).toBeInTheDocument();
  });
  ...
  it('self-host link points to GitHub', () => {
    ...
    expect(link).toHaveAttribute('href', 'https://github.com/mauriceboe/TRAVELOOP');
