...
const COOKIE_NAME = 'traveloop_session';
 ...
 * TRAVELOOP running behind Traefik / Caddy / Cloudflare Tunnel with
 ...
 * `X-Forwarded-Proto` once `trust proxy` is set (TRAVELOOP sets it to `1`
