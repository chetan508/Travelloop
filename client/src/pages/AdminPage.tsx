              ...
              {isLoading ? (
                ...
                <div className="overflow-x-auto">
                  <table className="w-full">
                    ...
                    <tbody className="divide-y divide-slate-100 traveloop-stagger">
                      {users.map(u => (
                ...
                <div className="bg-white rounded-xl border border-slate-200 overflow-hidden">
                  ...
                  <div className={`p-6 space-y-3 ${!emailActive ? 'opacity-50 pointer-events-none' : ''}`}>
                    {smtpLoaded && [
                      ...
                      { key: 'smtp_user', label: 'SMTP User', placeholder: 'traveloop@example.com' },
                      { key: 'smtp_pass', label: 'SMTP Password', placeholder: '••••••••', type: 'password' },
                      { key: 'smtp_from', label: 'From Address', placeholder: 'traveloop@example.com' },
                    ].map(field => (
                      <div key={field.key}>
        ...
        >
          ...
          >
            ...
            <div style={{ padding: '20px 24px' }}>
              ...
              >
{`docker pull mauriceboe/traveloop:latest
