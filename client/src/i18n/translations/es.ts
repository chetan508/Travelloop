const es: Record<string, string> = {
  ...
  'settings.about.supporters.title': 'Compañía de viaje para TRAVELOOP',
  'settings.about.supporters.subtitle': 'Mientras planeas tu próxima ruta, estas personas ayudan a planear el futuro de TRAVELOOP. Su aporte mensual va directo al desarrollo y a las horas reales invertidas — para que TRAVELOOP siga siendo Open Source.',
  ...
  'login.createAdminHint': 'Configura la primera cuenta administradora de TRAVELOOP.',
  ...
  'admin.addons.subtitle': 'Activa o desactiva funciones para personalizar tu experiencia en TRAVELOOP.',
  ...
  'admin.github.support': 'Ayuda a seguir desarrollando TRAVELOOP',
  ...
  'admin.update.dockerText': 'Tu instancia de TRAVELOOP se ejecuta en Docker. Para actualizar a {version}, ejecuta los siguientes comandos en tu servidor:',
  ...
  'vacay.sharingHint': 'Comparte tu calendario de vacaciones con otros usuarios de TRAVELOOP',
  'vacay.owner': 'Propietario',
  'vacay.shareEmailPlaceholder': 'Correo electrónico del usuario de TRAVELOOP',
  ...
  'vacay.inviteHint': 'Invita a otro usuario de TRAVELOOP a compartir un calendario combinado de vacaciones.',
  ...
  'journey.pdf.madeWith': 'Hecho con TRAVELOOP',
  'journey.pdf.day': 'Día',
  ...
  // System notices
  'system_notice.welcome_v1.title': 'Bienvenido a TRAVELOOP',
  ...
  'system_notice.welcome_v1.hero_alt': 'Destino de viaje pintoresco con la interfaz de TRAVELOOP',
  ...
  'system_notice.v3_photos.body': '**Fotos** en el Planificador de Viajes han sido eliminadas. Tus fotos están a salvo — TRAVELOOP nunca modificó tu biblioteca de Immich o Synology.\n\nLas fotos ahora viven en el addon **Journey**. Journey es opcional — si aún no está disponible, pide a tu admin que lo active en Admin → Complementos.',
  ...
  'system_notice.v3_mcp.highlight_deprecated': 'Tokens estáticos traveloop_ obsoletos',
