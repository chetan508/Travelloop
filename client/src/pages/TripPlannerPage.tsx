...
export default function TripPlannerPage(): React.ReactElement | null {
  ...
  const connectionsStorageKey = tripId ? `traveloop:visible-connections:${tripId}` : null
    ...
    return (
      <div style={{
        ...
        <div style={{ marginBottom: 28 }}>
          <img
            src={document.documentElement.classList.contains('dark') ? '/icons/traveloop-loading-light.gif' : '/icons/traveloop-loading-dark.gif'}
            alt="Loading"
            width={64}
            height={64}
          />
