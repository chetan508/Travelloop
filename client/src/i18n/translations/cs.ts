const cs: Record<string, string | { name: string; category: string }[]> = {
  ...
  'settings.about.supporters.title': 'Společníci na cestě s TRAVELOOP',
  'settings.about.supporters.subtitle': 'Zatímco plánuješ další trasu, tihle lidé plánují společně se mnou budoucnost TRAVELOOP. Jejich měsíční příspěvek jde přímo na vývoj a reálně strávené hodiny — aby TRAVELOOP zůstal Open Source.',
  ...
  'login.createAdminHint': 'Nastavte první administrátorský účet pro TRAVELOOP.',
  ...
  'admin.addons.subtitle': 'Zapněte nebo vypněte funkce a přizpůsobte si TRAVELOOP.',
  ...
  'admin.github.by': 'od',
  'admin.github.support': 'Pomáhá udržovat vývoj TRAVELOOP',
  ...
  'admin.update.dockerText': 'Váš TRAVELOOP běží v Dockeru. Pro aktualizaci na verzi {version} spusťte na svém serveru tyto příkazy:',
  ...
  'vacay.sharingHint': 'Sdílejte svůj plán dovolené s ostatními uživateli TRAVELOOP',
  'vacay.owner': 'Vlastník',
  'vacay.shareEmailPlaceholder': 'E-mail uživatele TRAVELOOP',
  ...
  'vacay.inviteHint': 'Pozvěte jiného uživatele TRAVELOOP ke sdílení společného kalendáře dovolených.',
  ...
  'journey.pdf.madeWith': 'Vytvořeno pomocí TRAVELOOP',
  'journey.pdf.day': 'Den',
  ...
  // System notices
  'system_notice.welcome_v1.title': 'Vítejte v TRAVELOOP',
  ...
  'system_notice.welcome_v1.hero_alt': 'Malebné cestovní místo s rozhraním TRAVELOOP',
  ...
  'system_notice.v3_photos.body': '**Fotografie** v Plánovacím nástroji byly odebrány. Vaše fotografie jsou v bezpečí — TRAVELOOP nikdy neupravoval vaši knihovnu Immich nebo Synology.\n\nFotografie jsou nyní dostupné v doplňku **Journey**. Journey je volitelný — pokud ještě není k dispozici, požádejte svého správce, aby ho aktivoval v Admin → Doplňky.',
  ...
  'system_notice.v3_mcp.highlight_deprecated': 'Statické tokeny traveloop_ zastaralé',
